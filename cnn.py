...
# AUTHOR: Matthew Tom
# FILENAME: cnn.py
# SPECIFICATION: uses cnn to identify digits based on images
...
print("Needs the \"train\" and \"test\" folders with the images to be in the same directory as the program and not in a separate folder")
